...

{
    public interface IMatchResultService
    {
        ...
        Task<PagedResponseDTO<MatchResult>> GetMatchResultsByQueryWithPagination(int pageNumber, int pageSize, string? season, string? competition, string? stadium, string? team, string? result);
